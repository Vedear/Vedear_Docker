...
1) Приветственное сооббщение [1_greetings.sh](/Bash_Project/Scripts/1_greetings.sh)
2) Сумма чисел [2_calculate.sh](/Bash_Project/Scripts/2_calculate.sh)
3) Проверка чётности числа [3_even_not_even.sh](/Bash_Project/Scripts/3_even_not_even.sh)
4) Создание директорий и файлов [4_mdtest.sh](/Bash_Project/Scripts/4_mdtest.sh)
